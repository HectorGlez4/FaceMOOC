...
?>
    ...
    <div class="container well" id="contenu">
        ...
        <form class="login" action="<?php WEBROOT ?>../newPassword/<?php echo $token ?>" method="POST">
            ...
            <div class="form-group">
                Nouveau mot de passe : <input type="password" id="newMdp" class="form-control" placeholder="******"
                                              name="newMdp" autofocus>
            </div>
            <div class="form-group">
                Confirmer nouveau mot de passe : <input type="password" id="newMdpVerif" class="form-control"
                                                        placeholder="******" name="newMdpVerif" autofocus>
            </div>
